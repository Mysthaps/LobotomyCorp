...
blind.set_blind = function(self, reset, silent)
    ...
    -- increase blind size
    local chips = get_blind_amount(G.GAME.round_resets.ante) * G.GAME.starting_params.ante_scaling * (G.jokers.config.card_limit > 3 and G.jokers.config.card_limit - 3 or 0) * 1
