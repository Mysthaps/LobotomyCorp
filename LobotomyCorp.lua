...
function Game.update(self, dt)
    ...
    if not G.SETTINGS.paused and G.GAME and G.GAME.modifiers.lobc_yesod and G.GAME.round_resets.ante > 6 and G.STATE ~= G.STATES.GAME_OVER and G.LANGUAGES and G.LANG and G.FONTS then
        G.LANG.font = G.FONTS["blank"]
    else
